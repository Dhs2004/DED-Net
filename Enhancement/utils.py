    ...
    def count_flops(self):
        ...
        def hook(module, input, output):
            if isinstance(module, nn.Conv2d):
                batch_size, in_channels, input_h, input_w = input[0].size()
                out_channels, _, kernel_h, kernel_w = module.weight.size()
                output_h, output_w = output.size()[2:]

                flops = (kernel_h * kernel_w * in_channels * output_h * output_w * out_channels) * batch_size
